...
var _user$project$Records$subscriptions = function (model) {
	return _user$project$Ports$ssData(_user$project$MessageTypes$GetValuesFromSS);
};
var _user$project$Records$main = {
	main: _elm_lang$html$Html_App$program(
		{init: _user$project$Model$init, view: _user$project$View$view, update: _user$project$Update$update, subscriptions: _user$project$Records$subscriptions})
};

var Elm = {};
Elm['Records'] = Elm['Records'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Records'], 'Records', typeof _user$project$Records$main === 'undefined' ? null : _user$project$Records$main);
